...
- Read the <a href={prepareURL("docs/guides/brandguide")}>Brand Guide</a> for UI patterns
- Explore the <a href={prepareURL("docs/api")}>REST API</a> documentation
- Review the <a href={prepareURL("docs/guides/testing")}>Testing Guide</a>
- Understand the <a href={prepareURL("docs/architecture/cqrs/")}>CQRS Architecture Guide</a>
