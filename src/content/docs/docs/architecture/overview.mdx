...
See <a href={prepareURL("docs/api")}>REST API Documentation</a> for endpoint details.

## Further Reading

- <a href={prepareURL("docs/architecture/domain/")}>Domain Models</a> - Entity relationships
- <a href={prepareURL("docs/architecture/cqrs/")}>CQRS Pattern</a> - Command/Query separation
- <a href={prepareURL("docs/guides/testing/")}>Testing Guide</a> - Test architecture